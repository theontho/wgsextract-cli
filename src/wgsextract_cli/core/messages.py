...
CLI_HELP = {
    ...
    "arg_debug": "Enable verbose debug logging. (Env: WGSE_DEBUG_MODE=1)",
    "arg_full_help": "Print help info for all subcommands.",
    "arg_vcf_input": "Input VCF file path. (Env: WGSE_DEFAULT_INPUT_VCF)",
    "arg_mother": "Mother VCF file path for trio analysis. (Env: WGSE_MOTHER_VCF_PATH)",
    "arg_father": "Father VCF file path for trio analysis. (Env: WGSE_FATHER_VCF_PATH)",
    "arg_input": "Path to the input BAM/CRAM or FASTQ file. (Env: WGSE_INPUT_PATH)",
    "arg_outdir": "Destination directory for outputs. (Env: WGSE_OUTPUT_DIRECTORY)",
    "arg_ref": "Path to the reference genome FASTA. (Env: WGSE_REFERENCE_FASTA)",
    "arg_threads": "CPU threads to use. (Env: WGSE_CPU_THREADS)",
    "arg_memory": "Memory limit per thread (e.g., '2G'). (Env: WGSE_MEMORY_LIMIT)",
    ...
    "arg_vcf_inputs": "One or more input VCF files (e.g., SNV, CNV, SV). (Env: WGSE_VCF_INPUT_PATHS)",
    "arg_batch": "Path to a CSV/TSV file for batch processing multiple samples. (Env: WGSE_BATCH_FILE_PATH)",
