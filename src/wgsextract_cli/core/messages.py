...
CLI_HELP = {
    ...
    "arg_vcf_input": "Input VCF file path. (Env: WGSE_INPUT_VCF)",
    "arg_mother": "Mother VCF file path for trio analysis. (Env: WGSE_MOTHER_VCF)",
    "arg_father": "Father VCF file path for trio analysis. (Env: WGSE_FATHER_VCF)",
