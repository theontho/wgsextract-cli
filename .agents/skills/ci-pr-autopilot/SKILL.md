...
- If the current checkout is the default branch with intended uncommitted work and no PR branch exists yet, first turn that work into a dedicated PR branch before continuing.

## Initial Discovery

1. Capture baseline git state first:
